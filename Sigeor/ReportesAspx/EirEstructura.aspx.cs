...
{
    public partial class EirEstructura : System.Web.UI.Page
    {
        ...
        protected void VerReporte(object sender, EventArgs e)
        {
            try
            {
                GestionUtil.VerReporte(this, "EirEstructuraReport", RecuperarFiltros());
        ...
        private void CargarDatosPaginadosPorNavegacion(object sender)
        {
            try
            {
                ...
                if (control != null)
                {
                    ...
                    result = servicio.ObtenerDatosEirEstructuraPaginado(out _totalRegistros, RecuperarFiltros(), PageSizeActual, PageIndexActual - 1);
        ...
        public void obtenerValoresCampos() {
            ...
            cod_agencia = ddlagencia.SelectedValue.Trim();
        ...
        private void CargarDatosPorEstadoCoincidencia()
        {
            try
            {
             ...
             result = servicio.ObtenerDatosEirEstructuraPaginado(out _totalRegistros, RecuperarFiltros(), PageSizeActual, PageIndexActual - 1);
                lista = !string.IsNullOrEmpty(result) ? Serializador.DeSerializeEntity<List<GET_EIR_ESTRUCTURA_Result>>(result) : null;
                BindingDatosPaginadosPorLista(lista, _totalRegistros);
        ...
        private void BindingDatosPaginadosPorLista(List<GET_EIR_ESTRUCTURA_Result> lista, int totalRegistros)
        {
            try
            {
                var totalPaginas =
