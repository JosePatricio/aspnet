<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestionPerfilesWebForm.aspx.cs"
    Inherits="Sigeor.Configuracion.GestionPerfilesWebForm" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="row">
                        <div align="center">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="PerfilesGridView" Width="96%" runat="server" AllowSorting="false"
                                    CssClass="table table-striped table-bordered table-condensed table-hover small table-hover table-responsive"
                                    AlternatingRowStyle-BackColor="#E6E6FA" OnRowDataBound="PerfilesGridView_RowDataBound"
                                                ...
                                                <div align="center">
                                                    <asp:Panel ID="Panel1" runat="server">
                                                        <asp:CheckBox Width="10%" CssClass="CheckEstado" ID="EstadoCheckBoxGridView" runat="server"
                                                            AutoPostBack="true" Checked='<%#Eval("Estado")%>' OnCheckedChanged="EstadoCheckBoxGridView_CheckedChanged"
                                                            ToolTip='<%#Eval("Estado").Equals(true)?"Inactivar Registro":"Activar Registro"%>' />
                            ...
                            <div class="modal-body" align="center">
                                <div class="table-responsive">
                                    <table style="border-spacing: 2px; border-collapse: separate; margin-left: 15px"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label3" runat="server" Text="Código" CssClass="lbl" />
                                            </td>
                                            <td style="width: 50%;">
                                            ...
                                            <td rowspan="5" style="width: 50%;">
                                                <div style="height: 200px; width: 100%; overflow: auto;">
                                                    ...
                                                    <asp:GridView ID="gridviewPrueba" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="Descripcion" HeaderText="MÓDULOS DISPONIBLES" HtmlEncode="false" />
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label6" runat="server" Text="Descripción" />
                                            </td>
                                            <td>
                                                <asp:TextBox autocomplete="off" ID="DescripcionModalTxt" CssClass="form-control" runat="server" TextMode="multiline"
                                                    Columns="20" Rows="3" MaxLength="250" />
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <asp:Label runat="server" Text="Página de Inicio :" />
                                            </td>
                                            <td>
                                                <asp:DropDownList data-placeholder="Elija una página..." runat="server" ID="ddlpagina"
                                                    OnSelectedIndexChanged="ddlpagina_SelectedIndexChanged" CssClass="form-control"
                                                    AutoPostBack="true" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label5" runat="server" Text="URL de Inicio :" />
                                            </td>
                                            <td>
                                                <asp:TextBox autocomplete="off" ID="txturlinicio" CssClass="form-control" Enabled="false" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
