<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstimacionEstructuraWebForm.aspx.cs"
    Inherits="Sigeor.GestionControl.EstimacionEstructuraWebForm" MaintainScrollPositionOnPostback="true" Culture="es-EC" %>
                                        ...
                                        <asp:GridView ID="EorCabeceraEstructuraGridView" runat="server" AllowSorting="false"
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="NumEorSort">
                                                    <HeaderTemplate>
                                                        <asp:Label runat="server" Text="NUM. EOR" CommandName="Sort" CommandArgument="NUM_EOR" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <%#Eval("NUM_EOREST")%>
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="CodTipContainerSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="T. CONTAINER" CommandName="Sort" CommandArgument="TIP_CONTAINER" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div align="center">
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="FechaeEorSort">
                                                    ...
                                                    <ItemTemplate>
                                                        <div align="center"><%#Eval("FECHA_EOR")%></div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <Columns>
                                                <asp:TemplateField SortExpression="FechaAprobacionSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="LinkButton3" runat="server" Text="F. APROBACIÓN" CommandName="Sort"
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="FechaReparaSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="LinkButton4" runat="server" Text="F. REPARACIÓN" CommandName="Sort"
                                                            CommandArgument="FECHA_REPARACION" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="EstadoSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" Text="ESTADO" CommandName="Sort"
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="TotalRealSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="CM. ESTIMADO" CommandName="Sort" CommandArgument="VALORREAL" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div align="right">
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="TotalEstSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="CM. REAL" CommandName="Sort" CommandArgument="TOTALEST" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div align="right">
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="DiferenciaSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="CMO. ESTIMADO" CommandName="Sort" CommandArgument="DIFERENCIA" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div align="right">
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="DiferenciaSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="CMO. REAL" CommandName="Sort" CommandArgument="DIFERENCIA" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div align="right">
