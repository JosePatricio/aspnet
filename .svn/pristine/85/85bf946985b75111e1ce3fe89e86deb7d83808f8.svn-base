<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EorCabeceraTransitoWebForm.aspx.cs"
    Inherits="Sigeor.GestionMgl.EorCabeceraTransitoWebForm" MaintainScrollPositionOnPostback="true" Culture="es-EC" %>
                                ...
                                <div id="filtros" class="panel-collapse collapse in">
                                    <div class="panel-body center-block">
                                        <div class="row" style="text-align: right; margin: auto;">
                                            ...
                                            <div class="col-sm-2">
                                                <%--<asp:DropDownList runat="server" ID="ddlAgencia" CssClass="form-control" />--%>
                                        ...
                                        <asp:GridView ID="EorCabeceraTransitoGridView" runat="server" AllowSorting="false"
                                           ...
                                           <EmptyDataRowStyle BackColor="LightBlue" />
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="FechaeEorSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="F. REP. EST." CommandName="Sort" CommandArgument="FECHA_REPARACIONEST" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="FechaeEorSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="F. REP. MAQ." CommandName="Sort" CommandArgument="FECHA_REPARACIONMAQ" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
