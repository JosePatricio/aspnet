<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambiarClave.aspx.cs" Inherits="Sigeor.Autenticacion.CambiarClave" %>
...
<body>
    ...
    <div class="card card-container">
        ...
        <h1 id="tituloLogin">
            <asp:Label runat="server" Text="CAMBIAR CONTRASEÑA" ForeColor="White" />
        </h1>
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="cuadroLogin">
                        ...
                        <asp:TextBox autocomplete="off" ID="ContraseniaGeneradaTextBox" runat="server" CssClass="form-control"
                            TextMode="Password" ReadOnly="True" MaxLength="30" />
                        <asp:TextBox autocomplete="off" ID="NuevaContraseniaTextBox" runat="server" CssClass="form-control"
                            TextMode="Password" placeholder="Nueva Contraseña" MaxLength="30" />
                        <asp:TextBox autocomplete="off" ID="ConfirmarContraseniaTextBox" runat="server" CssClass="form-control"
                            TextMode="Password" placeholder="Confirmar Contraseña" MaxLength="30" />
