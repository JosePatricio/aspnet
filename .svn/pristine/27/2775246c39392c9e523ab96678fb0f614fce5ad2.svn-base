<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstimacionMaquinariaWebForm.aspx.cs"
    Inherits="Sigeor.GestionControl.EstimacionMaquinariaWebForm" MaintainScrollPositionOnPostback="true" Culture="es-EC" %>
                                        ...
                                        <asp:GridView ID="EorCabeceraMaquinariaGridView" runat="server" AllowSorting="false"
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="CodTipContainerSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="LinkButton5" runat="server" Text="T. CONTAINER" CommandName="Sort"
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="FechaeEorSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="FECHA EORMAQ" CommandName="Sort" CommandArgument="FECHA_EOR" />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
