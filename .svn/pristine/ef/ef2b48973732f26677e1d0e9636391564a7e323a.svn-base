...
namespace Sigeor.GestionMgl
{
    ...
    public partial class EorCabeceraTransitoWebForm : System.Web.UI.Page
    {
        ...
        public EorCabeceraTransitoWebForm()
        {
            try
            {
        ...
        protected void VerReporte(object sender, EventArgs e)
        {
            try
            {
                GestionUtil.VerReporte(this, "EorCabeceraTransitoReport", RecuperarFiltros());
            }
            catch (Exception ex)
            {
