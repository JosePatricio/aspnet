<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EorCabeceraEstructuraWebForm.aspx.cs"
    Inherits="Sigeor.GestionMgl.EorCabeceraEstructuraWebForm" MaintainScrollPositionOnPostback="true" Culture="es-EC" %>
                                        ...
                                        <asp:GridView ID="EorCabeceraEstructuraGridView" runat="server" AllowSorting="false"
                                            ...
                                            <Columns>
                                                <asp:TemplateField SortExpression="CodTipContainerSort">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton runat="server" Text="T. CNTR" CommandName="Sort" CommandArgument="TIP_CONTAINER"
                                                            />
                                                        <br />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
